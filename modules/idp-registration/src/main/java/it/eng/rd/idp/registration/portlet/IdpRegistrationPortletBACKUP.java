...
//public class IdpRegistrationPortletBACKUP extends MVCPortlet {
//
...
////				addUserByIdM(request, response);
//				/*addUserByIdM(request, response, locale, resourceBundle, ri, companyId, idmUrl, idmEmailAdmin, adminEmail, idmPasswordAdmin, userEnabled, mailSubject, from, projectName, logoLiferayPortalUrl, liferayPortalName, liferayPortalUrl, copyrightCompany, copyrightCompanyUrl, templateID, organizationTypelist);*/
//			} else {
////				addUserByLiferay(request, response);
////				addUserByLiferay(request, response, locale, resourceBundle, ri, companyId, idmUrl, idmEmailAdmin, adminEmail, idmPasswordAdmin, userEnabled, mailSubject, from, projectName, logoLiferayPortalUrl, liferayPortalName, liferayPortalUrl, copyrightCompany, copyrightCompanyUrl, templateID, organizationTypelist);
//				addUserByLiferay(request, response, liferayEnabled, locale, resourceBundle, portletPreferences, ri, companyId, organizationTypelist);
//			}
//		}
//	}
//	
...
//			String templateID,
//			String organizationTypelist) {*/
//		_log.info("addUserByLiferay method");
//
...
//			/*validate(companyId, 
//					ri.getUsername(), ri.getEmail(), ri.getPassword1(), ri.getPassword2(), ri.getOrganizationName(),
...
//				boolean autoScreenName = false;//true;
////				String screenName = ri.getUsername();//StringPool.BLANK;
...
//				
//				sendNotification(ri, portletPreferences, companyId, liferayEnabled);
//				
//				/*sendNotification(mailSubject, from, true, true, templateID, projectName, logoLiferayPortalUrl,
//						liferayPortalName, liferayPortalUrl, copyrightCompany, copyrightCompanyUrl, adminEmail,
//						ri.getEmail(), ri.getPassword1(), StringPool.BLANK, ri.getOrganizationType(), ri.getOrganizationName(), ri.getName(), ri.getSurname(), ri.getQuestion(),
//						ri.getReply(), ri.getOrganizationWebSite(), ri.isAddContentEnabled());*/
//				
//			}catch (Exception e) {
...
//			 ri.getOrganizationWebSite());*/
//
//			/*registerIdmUser(idmEmailAdmin, false, userEnabled, idmPasswordAdmin, mailSubject, from, templateID, ri.getUsername(),
...
//	/*private void registerIdmUser(String idmEmailAdmin, 
//			boolean liferayEnabled, 
//			boolean userEnabled, 
//			String idmPasswordAdmin, 
//			String mailSubject,
...
//			String reply, 
//			String website, 
//			boolean addContentEnabled) throws AddIdmUserException, IdmException, ClientProtocolException, IOException, JSONException {*/
//		
//		String	idmUrl = StringUtil.trim(portletPreferences.getValue("idmUrl", _idpRegistrationConfiguration.idmUrl()));
//		String	idmEmailAdmin = StringUtil.trim(portletPreferences.getValue("idmEmailAdmin", _idpRegistrationConfiguration.idmEmailAdmin()));
//		String	idmPasswordAdmin = portletPreferences.getValue("idmPasswordAdmin", _idpRegistrationConfiguration.idmPasswordAdmin());
...
//					}
//
//					/*sendNotification(mailSubject, from, liferayEnabled, userEnabled, templateID, projectName, logoLiferayPortalUrl,
//							liferayPortalName, liferayPortalUrl, copyrightCompany, copyrightCompanyUrl, adminEmail,
...
//	}
//
//	/*private void sendNotification(String mailSubject, 
//			String from, 
//			boolean liferayEnabled, 
//			boolean userEnabled, 
//			String templateID,
