...
public interface DymerEntryService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DymerEntryServiceUtil} to access the dymer entry remote service. Add custom service methods to <code>it.eng.rd.dymer.service.impl.DymerEntryServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@Deprecated
