...
/**
 * Provides the local service interface for Dymer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ENGRD
 * @see DymerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DymerLocalService
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Dymer> getDymersByUuidAndCompanyId(String uuid, long companyId);
