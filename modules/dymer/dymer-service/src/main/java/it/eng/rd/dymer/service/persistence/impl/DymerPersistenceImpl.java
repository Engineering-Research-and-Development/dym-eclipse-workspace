...
public class DymerPersistenceImpl
	...
	public void cacheResult(Dymer dymer) {
		entityCache.putResult(DymerImpl.class, dymer.getPrimaryKey(), dymer);
	...
	public void cacheResult(List<Dymer> dymers) {
		for (Dymer dymer : dymers) {
			if (entityCache.getResult(DymerImpl.class, dymer.getPrimaryKey()) ==
					null) {
	...
	public void clearCache(Dymer dymer) {
		entityCache.removeResult(DymerImpl.class, dymer);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(DymerImpl.class, primaryKey);
		}
	}
	...
	public Dymer updateImpl(Dymer dymer) {
		...
		entityCache.putResult(DymerImpl.class, dymerModelImpl, false, true);
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new DymerModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Dymer.class.getName()));
	...
	private static class DymerModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			DymerModelImpl dymerModelImpl = (DymerModelImpl)baseModel;

			long columnBitmask = dymerModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(dymerModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |= dymerModelImpl.getColumnBitmask(
						columnName);
				}
		...
		private Object[] _getValue(
			DymerModelImpl dymerModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = dymerModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
					arguments[i] = dymerModelImpl.getColumnValue(columnName);
				}
			}
