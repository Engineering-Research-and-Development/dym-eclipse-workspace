...
/**
 * The persistence interface for the sandbox service.
 *
 * <p>
 ...
 */
@ProviderType
public interface SandboxPersistence extends BasePersistence<Sandbox> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SandboxUtil} to access the sandbox persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<Sandbox> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Sandbox> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Sandbox> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Sandbox>
			orderByComparator);
	 ...
	 * @return the matching sandboxes
	 */
	public java.util.List<Sandbox> findByUuid_C(String uuid, long companyId);
	 ...
	 * @return the range of matching sandboxes
	 */
	public java.util.List<Sandbox> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<Sandbox> sandboxes);
	 ...
	 */
	public java.util.List<Sandbox> findAll();
	 ...
	 */
	public java.util.List<Sandbox> findAll(int start, int end);
