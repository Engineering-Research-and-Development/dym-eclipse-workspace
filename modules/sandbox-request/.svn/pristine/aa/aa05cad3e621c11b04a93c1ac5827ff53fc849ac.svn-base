...
/**
 * Provides the local service interface for Sandbox. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SandboxLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SandboxLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.rd.sandbox.request.service.impl.SandboxLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sandbox local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SandboxLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Sandbox createSandbox(long sandboxId);
	...
	public Sandbox deleteSandbox(long sandboxId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Sandbox deleteSandbox(Sandbox sandbox);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Sandbox fetchSandbox(long sandboxId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Sandbox fetchSandboxByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Sandbox getSandbox(long sandboxId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Sandbox getSandboxByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Sandbox> getSandboxes(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Sandbox> getSandboxesByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Sandbox updateSandbox(Sandbox sandbox);
