...
/**
 * Provides the local service interface for Cocreator. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ENGRD
 * @see CocreatorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CocreatorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.rd.collaborativecreation.service.impl.CocreatorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cocreator local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CocreatorLocalServiceUtil} if injection and service tracking are not available.
	 */
