...
public class ActivityLocalServiceWrapper
	...
	public it.eng.rd.collaborativecreation.model.Activity addActivity(
		it.eng.rd.collaborativecreation.model.Activity activity) {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Activity createActivity(
		long activityId) {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Activity deleteActivity(
		it.eng.rd.collaborativecreation.model.Activity activity) {
	...
	@Override
	public it.eng.rd.collaborativecreation.model.Activity fetchActivity(
		long activityId) {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Activity getActivity(
			long activityId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Activity updateActivity(
		it.eng.rd.collaborativecreation.model.Activity activity) {
