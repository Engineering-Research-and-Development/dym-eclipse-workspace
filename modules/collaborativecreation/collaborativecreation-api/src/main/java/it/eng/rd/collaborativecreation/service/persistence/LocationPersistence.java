...
public interface LocationPersistence extends BasePersistence<Location> {
	 ...
	 */
	public java.util.List<Location> findByName(String name);
	 ...
	 */
	public java.util.List<Location> findByName(String name, int start, int end);
	 ...
	 */
	public java.util.List<Location> findByName(
