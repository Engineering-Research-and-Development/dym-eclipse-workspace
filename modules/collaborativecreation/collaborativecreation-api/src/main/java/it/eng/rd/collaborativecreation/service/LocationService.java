...
public interface LocationService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.rd.collaborativecreation.service.impl.LocationServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the location remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LocationServiceUtil} if injection and service tracking are not available.
	 */
