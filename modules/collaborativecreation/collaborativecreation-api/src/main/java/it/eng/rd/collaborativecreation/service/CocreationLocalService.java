...
/**
 * Provides the local service interface for Cocreation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ENGRD
 * @see CocreationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CocreationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.eng.rd.collaborativecreation.service.impl.CocreationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cocreation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CocreationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Cocreation addCocreation(Cocreation cocreation);
	...
	public Cocreation createCocreation(long cocreationId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Cocreation deleteCocreation(long cocreationId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Cocreation fetchCocreation(long cocreationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Cocreation fetchCocreationByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Cocreation getCocreationByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Cocreation> getCocreationsByUserId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Cocreation> getCocreationsByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Cocreation updateCocreation(Cocreation cocreation);
