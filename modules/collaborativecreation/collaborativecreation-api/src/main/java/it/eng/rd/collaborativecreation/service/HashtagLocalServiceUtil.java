...
/**
 * Provides the local service utility for Hashtag. This utility wraps
 * <code>it.eng.rd.collaborativecreation.service.impl.HashtagLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HashtagLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.eng.rd.collaborativecreation.service.impl.HashtagLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Hashtag addHashtag(Hashtag hashtag) {
	 ...
	 */
	public static Hashtag createHashtag(long hashtagId) {
		return getService().createHashtag(hashtagId);
	}
	 ...
	 */
	public static Hashtag deleteHashtag(Hashtag hashtag) {
		return getService().deleteHashtag(hashtag);
	}
	...
	public static Hashtag fetchHashtag(long hashtagId) {
		return getService().fetchHashtag(hashtagId);
	}
	 ...
	 * @throws PortalException if a hashtag with the primary key could not be found
	 */
	public static Hashtag getHashtag(long hashtagId) throws PortalException {
	 ...
	 */
	public static int getHashtagsCount() {
		return getService().getHashtagsCount();
	}
	 ...
	 */
	public static Hashtag updateHashtag(Hashtag hashtag) {
		return getService().updateHashtag(hashtag);
	}

	public static HashtagLocalService getService() {
		return _service;
	}

	private static volatile HashtagLocalService _service;
