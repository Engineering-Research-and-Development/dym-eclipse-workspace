...
public class CategoryLocalServiceWrapper
	...
	public it.eng.rd.collaborativecreation.model.Category addCategory(
		it.eng.rd.collaborativecreation.model.Category category) {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Category createCategory(
		long categoryId) {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Category deleteCategory(
		it.eng.rd.collaborativecreation.model.Category category) {
	...
	@Override
	public it.eng.rd.collaborativecreation.model.Category fetchCategory(
		long categoryId) {
	 ...
	 */
	@Override
	public it.eng.rd.collaborativecreation.model.Category updateCategory(
		it.eng.rd.collaborativecreation.model.Category category) {
