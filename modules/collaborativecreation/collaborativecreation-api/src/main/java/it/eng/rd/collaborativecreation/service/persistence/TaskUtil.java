...
public class TaskUtil {
	 ...
	 * @return the matching tasks
	 */
	public static List<Task> findByCocreation(long userId, long cocreationId) {
		return getPersistence().findByCocreation(userId, cocreationId);
	}
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByCocreation_First(
	 ...
	 * @return the first matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByCocreation_First(
		long userId, long cocreationId,
		OrderByComparator<Task> orderByComparator) {
	 ...
	 * @throws NoSuchTaskException if a matching task could not be found
	 */
	public static Task findByCocreation_Last(
			long userId, long cocreationId,
			OrderByComparator<Task> orderByComparator)
		throws it.eng.rd.collaborativecreation.exception.NoSuchTaskException {
	 ...
	 * @return the last matching task, or <code>null</code> if a matching task could not be found
	 */
	public static Task fetchByCocreation_Last(
		long userId, long cocreationId,
		OrderByComparator<Task> orderByComparator) {
	 ...
	 */
	public static Task[] findByCocreation_PrevAndNext(
			long taskId, long userId, long cocreationId,
			OrderByComparator<Task> orderByComparator)
		throws it.eng.rd.collaborativecreation.exception.NoSuchTaskException {

		return getPersistence().findByCocreation_PrevAndNext(
			taskId, userId, cocreationId, orderByComparator);
	}
	 ...
	 * @param cocreationId the cocreation ID
	 */
	public static void removeByCocreation(long userId, long cocreationId) {
		getPersistence().removeByCocreation(userId, cocreationId);
	}
	 ...
	 * @return the number of matching tasks
	 */
	public static int countByCocreation(long userId, long cocreationId) {
		return getPersistence().countByCocreation(userId, cocreationId);
	}
