 ...
 * <code>it.eng.rd.collaborativecreation.service.impl.QuestionLocalServiceImpl</code> and
...
public class QuestionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.eng.rd.collaborativecreation.service.impl.QuestionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the question that was removed
	 */
	public static Question deleteQuestion(Question question) {
	...
	public static Question fetchQuestion(long questionId) {
	 ...
	 * @throws PortalException if a question with the primary key could not be found
	 */
	public static Question getQuestion(long questionId) throws PortalException {
	 ...
	 */
	public static List<Question> getQuestions(int start, int end) {
	...
	private static volatile QuestionLocalService _service;
