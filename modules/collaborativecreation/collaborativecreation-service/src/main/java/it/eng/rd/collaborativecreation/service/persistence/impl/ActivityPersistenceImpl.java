...
public class ActivityPersistenceImpl
	 ...
	 */
	@Override
	public List<Activity> findByCocreation(long cocreationId) {
	 ...
	 */
	@Override
	public List<Activity> findByCocreation(
		long cocreationId, int start, int end) {

		return findByCocreation(cocreationId, start, end, null);
	}
	...
	public List<Activity> findByCocreation(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Activity activity : list) {
					if (cocreationId != activity.getCocreationId()) {
						list = null;
	...
	public Activity findByCocreation_First(
		...
		Activity activity = fetchByCocreation_First(
	...
	public Activity fetchByCocreation_First(
		...
		List<Activity> list = findByCocreation(
	...
	public Activity findByCocreation_Last(
		...
		Activity activity = fetchByCocreation_Last(
			cocreationId, orderByComparator);
	...
	public Activity fetchByCocreation_Last(
		...
		int count = countByCocreation(cocreationId);
	...
	public Activity[] findByCocreation_PrevAndNext(
		...
		try {
			...
			array[0] = getByCocreation_PrevAndNext(
				session, activity, cocreationId, orderByComparator, true);

			array[1] = activity;

			array[2] = getByCocreation_PrevAndNext(
				session, activity, cocreationId, orderByComparator, false);
	...
	protected Activity getByCocreation_PrevAndNext(
		Session session, Activity activity, long cocreationId,
