...
public class CocreatorLocalServiceImpl extends CocreatorLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>it.eng.rd.collaborativecreation.service.CocreatorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.eng.rd.collaborativecreation.service.CocreatorLocalServiceUtil</code>.
	 */
}