...
/**
 * Provides the base implementation for the cocreation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.rd.collaborativecreation.service.impl.CocreationLocalServiceImpl}.
 * </p>
 *
 * @author ENGRD
 * @see it.eng.rd.collaborativecreation.service.impl.CocreationLocalServiceImpl
 * @generated
 */
public abstract class CocreationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CocreationLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CocreationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CocreationLocalServiceUtil</code>.
	 */
	...
	public Cocreation addCocreation(Cocreation cocreation) {
		...
		return cocreationPersistence.update(cocreation);
	}
	...
	public Cocreation createCocreation(long cocreationId) {
		return cocreationPersistence.create(cocreationId);
	}
	...
	public Cocreation deleteCocreation(long cocreationId)
		...
		return cocreationPersistence.remove(cocreationId);
	}
	...
	public Cocreation deleteCocreation(Cocreation cocreation) {
		return cocreationPersistence.remove(cocreation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Cocreation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cocreationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cocreationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cocreationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return cocreationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Cocreation fetchCocreation(long cocreationId) {
		return cocreationPersistence.fetchByPrimaryKey(cocreationId);
	}
	...
	public Cocreation fetchCocreationByUuidAndGroupId(
		...
		return cocreationPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cocreationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Cocreation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("cocreationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			cocreationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Cocreation.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Cocreation>() {

				@Override
				public void performAction(Cocreation cocreation)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, cocreation);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cocreationPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return cocreationLocalService.deleteCocreation(
			(Cocreation)persistedModel);
	}

	public BasePersistence<Cocreation> getBasePersistence() {
		return cocreationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return cocreationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Cocreation> getCocreationsByUuidAndCompanyId(
		...
		return cocreationPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Cocreation> getCocreationsByUuidAndCompanyId(
		...
		return cocreationPersistence.findByUuid_C(
	...
	public Cocreation getCocreationByUuidAndGroupId(String uuid, long groupId)
		...
		return cocreationPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Cocreation> getCocreations(int start, int end) {
		return cocreationPersistence.findAll(start, end);
	}
	...
	public int getCocreationsCount() {
		return cocreationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CocreationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		cocreationLocalService = (CocreationLocalService)aopProxy;

		_setLocalServiceUtilService(cocreationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CocreationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cocreationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CocreationLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cocreationLocalService);
		}
	...
	protected CocreationLocalService cocreationLocalService;
