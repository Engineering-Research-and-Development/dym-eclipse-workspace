...
import it.eng.rd.collaborativecreation.service.LocationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.rd.collaborativecreation.service.impl.LocationLocalServiceImpl}.
 * </p>
 *
 * @author ENGRD
 * @see it.eng.rd.collaborativecreation.service.impl.LocationLocalServiceImpl
 * @generated
 */
public abstract class LocationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LocationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LocationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LocationLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Location.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return locationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return locationPersistence.countWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return locationPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public BasePersistence<Location> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LocationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		locationLocalService = (LocationLocalService)aopProxy;

		_setLocalServiceUtilService(locationLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = LocationLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, locationLocalService);
		}
