...
import it.eng.rd.collaborativecreation.service.ChallengeService;
import it.eng.rd.collaborativecreation.service.ChallengeServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.eng.rd.collaborativecreation.service.impl.ChallengeServiceImpl}.
 * </p>
 *
 * @author ENGRD
 * @see it.eng.rd.collaborativecreation.service.impl.ChallengeServiceImpl
 * @generated
 */
public abstract class ChallengeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ChallengeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ChallengeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ChallengeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ChallengeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		challengeService = (ChallengeService)aopProxy;

		_setServiceUtilService(challengeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ChallengeService.class.getName();
	}
	...
	private void _setServiceUtilService(ChallengeService challengeService) {
		try {
			Field field = ChallengeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, challengeService);
		}
	...
	@Reference
	protected it.eng.rd.collaborativecreation.service.ChallengeLocalService
