...
create index IX_DB3B4D13 on COCREATION_Challenge (title[$COLUMN_LENGTH:2000000$]);
...
create index IX_7ACF8683 on COCREATION_Cocreation (title[$COLUMN_LENGTH:2000000$]);
