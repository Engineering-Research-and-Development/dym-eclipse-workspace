...
<aui:fieldset>
	<div class="clearfix" style="margin-right:20px; margin-left:20px;">
        ...
        <div class="form-group"><label class="control-label" for="enterDate">Enter Date</label>
             <div><input class="form-control" id="enterDate" maxlength="30" type="text" value="" name="enterDate"/></div>
        </div>
        <div class="form-group"><label class="control-label" for="addParticipants">Add Participants</label>
             <div><input class="form-control" id="addParticipants" maxlength="30" type="text" value="" name="addParticipants"/></div>
        </div>
...
<aui:script use="liferay-util-window">
	A.one("#aui_popup_click").on('click',function(event){
 		var dialog = new A.Modal({
	 		title: "<b>Milestone added successfully</b>",
	 		bodyContent: "<b>Milestone added successfully !</b>",
	 		headerContent: "",
		    centered: true,
		    modal: true,
		    height: 200,
