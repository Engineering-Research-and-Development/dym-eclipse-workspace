...
if (isChallengeOwner){
	...
	if (keywords != null && !keywords.equalsIgnoreCase("")){        
		allCocreations = CocreationLocalServiceUtil.getCocreationsBySearchGroupId(keywords, themeDisplay.getScopeGroupId(), false);   
	}else{
		allCocreations = CocreationLocalServiceUtil.getCocreationsByGroupId(themeDisplay.getScopeGroupId(), false);
	}
			   ...
			   <div class="col col-lg-10 col-sm-10 col-10 col-md-12"> -->
				   		<aui:form action="" name="<portlet:namespace />fm">
					   		<div id="products" class="row view-group">
						   		...
						   		%>
						   			<h3 class="co-title"><liferay-ui:message key="thereAreNoOngoingCocreations"/></a></h3>
								<%
								}else{
							   		if (filteredCocreations.size() == 0){
							   		%>
							   			<h3 class="co-title"><liferay-ui:message key="youHaveNoOngoingCocreations"/></a></h3>
									<%
									}
								}
							                ...
							                <div class="caption card-body">
											    ...
											    <div class="col-12 p0 mb-2">
												    ...
												    <p id="cocreationDate" class="card-text group inner list-group-item-text">
												    	<b><label class="aui-field-label">Co-creation <liferay-ui:message key="createdOn"/></label></b> : <%=formatter.format(cocreation.getCreateDate())%>
							                    	</p>
							                    </div>
